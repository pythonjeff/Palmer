...
from palmer.db import get_all_profiles, upsert_profile, get_profile
from palmer.llm import client, SONNET_MODEL, _parse_json
from palmer.userprofile import PROFILE_FIELDS, prune_profile
...
def _clean_topics(profile: dict) -> dict:
    ...
    """
    from palmer.morning import _is_directive, _parse_commute_topic
