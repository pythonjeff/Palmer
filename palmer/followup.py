...
from palmer.userprofile import _is_duplicate_subject
from palmer.db import get_all_profiles, upsert_profile, save_message, get_history, claim_daily_guard
from palmer.morning import _local_now, _local_today
...
def _candidates(profile: dict, payload: dict | None, today) -> list[Subject]:
    ...
    if teams:
        try:
            from palmer.sports import team_day, result_line
            for team in teams:
