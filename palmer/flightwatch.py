...
from palmer.db import (get_active_flight_watches, update_flight_watch_price)
...
def _cheapest(watch: dict) -> float | None:
    ...
    from palmer.flights import _serpapi_flights_search
    try:
...
def run_flight_watches() -> None:
    ...
    from palmer.price_alert import draft_price_alert
