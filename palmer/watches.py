...
from palmer.agent import _build_system, base_system
from palmer.llm import client, HAIKU_MODEL, SONNET_MODEL
from palmer.smstext import _sms_clean, URL_RE
from palmer.datafeeds import _search_raw
from palmer.sources import source_tier, canonical_domain, corroborated
from palmer.userprofile import _is_duplicate_subject, _user_already_covered
...
from palmer.rubrics import classify_genre, rubric_for
...
def run_watches():
    ...
    from palmer.db import save_message
    ...
    from palmer.tapback import pacing_factor
