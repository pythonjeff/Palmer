...
from palmer.db import get_all_profiles, record_forecast, record_actual, pending_actuals
...
def _log_todays_forecasts(city: str, lat: float, lon: float, today: str) -> None:
    from palmer.weather import weather_snapshot, _is_us_coords
...
def best_source(city: str, incumbent: str = "nws", today=None) -> str | None:
    ...
    choice = None
    try:
        from palmer.db import forecast_scores
